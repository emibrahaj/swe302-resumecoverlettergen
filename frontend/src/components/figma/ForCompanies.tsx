"use client";
import {ArrowLeft, ArrowRight, BarChart3, Building2, Target, Users} from 'lucide-react';
...
export function ForCompanies({onBack, onRegisterClick}: ForCompaniesProps) {
    return (
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div>
                        ...
                        <p className="text-xl text-foreground/70 mb-8">
                            Join hundreds of companies using DiversiHire to discover talented professionals and streamline
                            your hiring process.
                        </p>
