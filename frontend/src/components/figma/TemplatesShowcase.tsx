        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {templates.map((template) => (
              ...
              >
                {template.popular && (
                    <div
                        className="absolute top-3 right-3 z-10 px-2 py-1 bg-yellow-400 text-purple-900 rounded-full flex items-center gap-1">
                ...
                {template.isPremium && (
                    <div
                        className="absolute top-3 left-3 z-10 px-2 py-1 bg-[#088395] text-white rounded-full flex items-center gap-1">
                      <Sparkles size={10}/>
                ...
                <div
                  ...
                  <button className="px-4 py-2 bg-white text-[#088395] rounded-lg font-semibold text-sm">
                    Use This Template
                  </button>
                </div>
              </div>
