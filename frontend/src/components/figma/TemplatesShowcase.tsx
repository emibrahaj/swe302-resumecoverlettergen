...
export function TemplatesShowcase({ onViewAll }: TemplatesShowcaseProps) {
  const templates = [
    {
      id: 1,
      name: 'Modern Minimal',
  ...
  return (
    <section id="templates" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white to-purple-50">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <button
            onClick={onViewAll}
            className="group inline-flex items-center gap-2 px-8 py-4 bg-[#088395] text-white rounded-lg hover:shadow-xl transition-all"
          >
            View All 900+ Templates
