"use client";
import {ArrowLeft, Award, BookOpen, Code, Database, Star, TrendingUp} from 'lucide-react';
...
export function Courses({onBack}: CoursesProps) {
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-cyan-50 py-16 px-4 sm:px-6 lg:px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl border-2 border-gray-200 p-8 text-center">
                    ...
                    <button
                        className="px-8 py-4 border-2 border-[#088395] text-[#088395] rounded-lg font-semibold hover:bg-[#088395] hover:text-white transition-all">
                        View All Courses
                    </button>
                </div>
            </div>
