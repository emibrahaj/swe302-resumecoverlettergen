          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div className="bg-gradient-to-r from-[#088395] to-teal-600 px-8 py-6">
              ...
              <p className="text-white/90">
                Get exclusive discounts on industry-leading courses to boost
                your career and strengthen your resume.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {courses.map((course, index) => (
            ...
            >
              <div className="p-6">
                ...
                <button className="w-full py-3 bg-[#088395] text-white rounded-lg font-semibold hover:shadow-lg transition-all">
                  Enroll Now
                </button>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border-2 border-gray-200 p-8 text-center">
          <h2 className="text-3xl font-bold mb-4">
            Why Choose Our Partner Courses?
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm text-foreground/70">
                Earn credentials that employers value
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-foreground/70">
                Add valuable skills to stand out
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-sm text-foreground/70">
                Save up to 40% on premium courses
              </p>
            </div>
          </div>
