...
export function UserNav({
    ...
    return (
        <nav
            className="fixed top-0 left-0 right-0 bg-white/80 backdrop-blur-md z-50 border-b border-border">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center gap-4 h-16">
                    ...
                    <div
                        className="hidden md:flex min-w-0 flex-1 items-center justify-center gap-3 lg:gap-5 xl:gap-7">
                        {!isCompany && (
                            <>
                                <button
                    ...
                    <div
                        className="hidden md:flex flex-shrink-0 items-center gap-3 lg:gap-5">
                        {!isCompany && (
                      ...
                      <span className="font-semibold text-sm">
                        Job Alert Notifications
                                        ...
                                        {notifications.length === 0 ? (
                                            <div
                                                className="px-4 py-8 text-center text-sm text-foreground/50">
                                                <Bell size={28}
                                                      className="mx-auto mb-2 opacity-30"/>
                                                No high-match jobs yet.
                                                <p className="text-xs mt-1">
                                                    Enable alerts in the
                                                    Find Jobs page.
                                                </p>
                                            </div>
                                        ) : (
                                                ...
                                                {notifications.map((notification) => (
                                                    ...
                                                    >
                                                        <div
                                                            ...
                                                            <div
                                                                className="mt-0.5 p-1.5 bg-[#088395]/10 rounded-lg shrink-0">
                                                                <Briefcase
                                                                    size={14}
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    className="inline-block mt-1 text-[11px] font-semibold text-green-700 bg-green-50 px-1.5 py-0.5 rounded-full">
                        ...
                        {isCompany ? (
                            ...
                            <div className="relative group">
                                <button
                                    className="flex items-center gap-1 px-4 py-2 text-foreground hover:text-[#088395] transition-colors font-medium">
                                    {t.nav.account}
                                    <ChevronDown size={16}/>
                                </button>

                                <div
                                    className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                                    <button
