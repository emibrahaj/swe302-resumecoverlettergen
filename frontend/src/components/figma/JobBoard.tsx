...
import { Search, MapPin, Briefcase, DollarSign, Clock, Building2, X, ArrowLeft, Lock } from 'lucide-react';
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {onBack && (
            <button
              onClick={onBack}
              className="flex items-center gap-2 text-foreground/70 hover:text-foreground mb-6"
            >
              <ArrowLeft size={20} />
              Back to Home
            </button>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <div className="flex items-center gap-2 text-foreground/70 mb-2">
                        <Building2 size={16} />
                        <span className={shouldBlurCompany ? 'blur-sm' : ''}>{job.company}</span>
                      </div>
                    </div>
                ...
                {isLocked && (
                  <div className="absolute inset-0 bg-white/95 rounded-xl flex items-center justify-center z-10 backdrop-blur-none">
                    <div className="text-center p-6">
                      ...
                      <h3 className="font-semibold text-lg mb-2">Upgrade to View More Jobs</h3>
