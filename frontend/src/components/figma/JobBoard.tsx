...
import {ArrowLeft, Building2, Clock, DollarSign, Lock, MapPin, Search, X} from 'lucide-react';
...
const mockJobs: Job[] = [
    {
        ...
        description: 'We are looking for an experienced Frontend Developer to join our growing team. You will be responsible for building beautiful, responsive web applications.',
        requirements: ['5+ years React experience', 'TypeScript', 'Modern CSS', 'Team collaboration']
    },
    {
        id: '2',
        ...
        requirements: ['3+ years PM experience', 'Agile methodology', 'Data-driven decision making', 'Stakeholder management']
    },
    {
        id: '3',
        title: 'UX Designer',
        ...
        requirements: ['Figma expertise', 'User research', 'Prototyping', 'Portfolio required']
    },
    {
        id: '4',
        ...
        requirements: ['AWS/Azure/GCP', 'Kubernetes', 'CI/CD', 'Infrastructure as Code']
    },
    {
        id: '5',
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-1 space-y-4">
                        ...
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <button
                                className="w-full py-2 bg-[#088395]/10 text-[#088395] rounded-lg hover:bg-purple-200 transition-colors">
                                Set Up Alerts
                            </button>
                        </div>
                    </div>
                            ...
                            return (
                                <div
                                    ...
                                    className={`bg-white rounded-xl shadow-sm border-2 p-6 relative transition-all ${
                                        isLocked ? 'cursor-not-allowed' : 'cursor-pointer hover:shadow-lg'
                                    } ${
                                        selectedJob?.id === job.id ? 'border-[#088395]' : 'border-gray-200'
                                    }`}
                                >
                                        ...
                                        <div className="flex items-start justify-between mb-4">
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 text-foreground/70 mb-2">
                                                    <Building2 size={16}/>
                                                    <span
                                                        className={shouldBlurCompany ? 'blur-sm' : ''}>{job.company}</span>
                                                </div>
                                            </div>
                                            <span
                    ...
                    {job.type.replace('-', ' ')}
                                                    ...
                                                    <ul className="space-y-1">
                                                        {job.requirements.map((req, index) => (
                                                            <li key={index}
                                                                ...
                                                                <span
                                                                    className="w-1.5 h-1.5 bg-[#088395] rounded-full"></span>
                                                                {req}
                                                            </li>
                                                        ))}
                                                    </ul>
                                    ...
                                    {isLocked && (
                                        <div
                                            className="absolute inset-0 bg-white/95 rounded-xl flex items-center justify-center z-10 backdrop-blur-none">
                                            <div className="text-center p-6">
                                                <Lock size={48} className="text-[#088395] mx-auto mb-4"/>
                                                <h3 className="font-semibold text-lg mb-2">Upgrade to View More
                                                    Jobs</h3>
            ...
            {showApplicationModal && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl max-w-2xl w-full p-8 relative max-h-[90vh] overflow-y-auto">
                        ...
                        <p className="text-foreground/70 mb-6">at {selectedJob?.company}</p>
                        ...
                        <form onSubmit={handleSubmitApplication} className="space-y-6">
                            ...
                            <div>
                                <label className="block mb-2 text-sm font-semibold">Upload Resume</label>
                                <input
                                    type="file"
                                    accept=".pdf,.doc,.docx"
                                    required
                            ...
                            <div>
                                <label className="block mb-2 text-sm font-semibold">Cover Letter</label>
                                <textarea
                                    rows={6}
