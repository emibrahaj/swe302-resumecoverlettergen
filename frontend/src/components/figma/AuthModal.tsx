...
export function AuthModal({
    ...
    return (
        <div
            ...
            <div
                className="bg-white rounded-2xl max-w-md w-full p-6 sm:p-8 relative my-4 sm:my-8 max-h-[calc(100vh-2rem)] overflow-y-auto">
                <button
                    onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                    {mode === 'signup' && (
                        <div>
                            <label className="block mb-2 text-sm">Full
                                Name</label>
                    ...
                    <div>
                        <label
                            className="block mb-2 text-sm">Password</label>
                        <div className="relative">
                            <Lock size={20}
                                  className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"/>
                            <input
                ...
                <div className="mt-4">
                    <div className="relative">
                        <div
                            ...
                            <div
                                className="w-full border-t border-gray-200"></div>
                        </div>
                        <div
                            className="relative flex justify-center text-xs">
                            <span
                                className="px-4 bg-white text-foreground/70">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-3">
                        ...
                        >
                            <GoogleLogo/>
                            <span
                                className="font-medium">{oauthBusy === 'google' ? 'Signing in…' : 'Google'}</span>
                        </button>
                        <button
                            type="button"
                        ...
                        >
                            <LinkedInLogo/>
                            <span
                                className="font-medium">{oauthBusy === 'linkedin' ? 'Signing in…' : 'LinkedIn'}</span>
                        </button>
                    </div>
                </div>
