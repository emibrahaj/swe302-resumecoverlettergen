...
import { FileText, Plus, MoreVertical, Download, Eye, Trash2, Copy, Star, TrendingUp, Briefcase, MessageSquare } from 'lucide-react';
...
export function Dashboard({ onCreateNew, onEditResume, onCreateCoverLetter, onUpgrade, onAnalyzeResume, onSubmitReview }: DashboardProps) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-6 text-white">
            ...
            <button
              onClick={onUpgrade}
              className="px-6 py-3 bg-white text-purple-600 rounded-lg font-semibold hover:shadow-xl transition-all"
            >
        ...
        <div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="px-3 py-2 border-2 border-gray-200 rounded-lg hover:border-[#088395] hover:text-[#088395] transition-colors">
                      <Download size={16} />
                    </button>
                    <button className="px-3 py-2 border-2 border-gray-200 rounded-lg hover:border-[#088395] hover:text-[#088395] transition-colors">
                      <Copy size={16} />
            ...
            <div
              onClick={onCreateNew}
              className="bg-white rounded-xl shadow-sm border-2 border-dashed border-gray-300 overflow-hidden hover:border-[#088395] hover:shadow-lg transition-all cursor-pointer group"
            >
              <div className="aspect-[8.5/11] flex items-center justify-center">
                <div className="text-center">
                  <div className="w-16 h-16 bg-[#088395]/10 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-[#088395] transition-colors">
                    <Plus size={32} className="text-[#088395] group-hover:text-white transition-colors" />
                  </div>
                  <p className="font-semibold text-foreground/70 group-hover:text-[#088395]">
                    Create New Resume
                  </p>
                </div>
              </div>
