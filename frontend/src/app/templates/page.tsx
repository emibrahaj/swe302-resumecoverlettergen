      ...
      <section className="min-h-[calc(100vh-88px)] bg-[rgba(226,190,255,0.11)] shadow-[inset_0_0_15px_4px_#924CCA]">
        <div className="mx-auto max-w-[1440px] px-8 py-16">
          <div className="text-center">
            ...
            <div className="mt-14 flex justify-center gap-6">
              <button
                ...
                className={`rounded-[10px] px-8 py-2 text-[24px] ${
                  templateType === "simple"
                    ? "bg-[#924CCA]"
                    : "bg-[#D9B9F0]"
                }`}
          ...
          <div className="relative mt-20 bg-[#d8d0dc] px-8 py-16">
            <button className="absolute left-10 top-1/2 z-20 flex h-[76px] w-[140px] -translate-y-1/2 items-center justify-center rounded-[15px] bg-[#924CCA]/50 text-6xl text-[#2b153d]">
              ‹
            </button>

            <button className="absolute right-10 top-1/2 z-20 flex h-[76px] w-[140px] -translate-y-1/2 items-center justify-center rounded-[15px] bg-[#924CCA]/50 text-6xl text-[#2b153d]">
              ›
            </button>
              ...
              {templates.map((template) => {
                ...
                return (
                  <button
                    ...
                    className={`relative shrink-0 transition duration-200 ${
                  ...
                  >
                    ...
                    {isSelected && (
                      <div className="absolute left-1/2 top-1/2 flex h-[70px] w-[250px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-[12px] bg-[#924CCA] text-[28px] font-bold text-white">
                        Choose
                      </div>
                    )}
                  </button>
