...
class UserProfile:
    def __init__(self, id: UUID, first_name: Optional[str], last_name: Optional[str], avatar_url: Optional[str], tier: str="free", created_at: Optional[datetime] = None):
        self.id = id
...
class CompanyProfile:
    def __init__(self, id: UUID, company_name: str, logo_url: Optional[str] = None,
...
class UserAnalysisHistory:
    def __init__(self, id: UUID, user_id: Optional[UUID], resume_id: Optional[UUID], match_score: Optional[int],
            skill_gap_analysis: Optional[Dict[str, Any]], cv_embedding: Optional[Any],
